...
Each recorder can be assigned a **location** to identify the deployment site. Choose a name that reflects the site's location, treatment, sampling design, or other meaningful identifier for your project.

Location names are limited to **12 characters**. Examples include:
...
::: {.callout-warning}
A **location** is required when uploading recordings to [WildTrax](https://wildtrax.ca). The location name links uploaded media to the correct deployment coordinates and metadata. See more under WildTrax's User Guide for [Locations](https://portal.wildtrax.ca/guide#sec-locations).
:::
...
**Location photos** are photos taken as a means to record the landscape around where a sensor was deployed. [WildTrax](https://wildtrax.ca) has the ability to upload, store and manage location photos and attribute basic metadata for them.

Locations photos are recommended in the following format:

- Cardinal directions: N, E, S, W
- Zenith (straight up) and nadir (straight down)
- A set up photo and a data sheet photo

::: {.callout-note}
## Location metadata

WildTrax can store a wide range of deployment and site metadata. Record any information that may be relevant to your project or future analyses, even if it is not currently supported by WildTrax. Additional metadata can always be maintained separately and linked to your deployments.
:::

## Retrieve

1.  Open the unit's lid and press and hold the PAIR/STATUS btton
2.  Open the Configurator app and locate the unit to re-pair.
3.  Check **battery level** and **SD card usage** to confirm recordings were captured successfully. Keep the SD stored in the unit until it can be safely transferred onto a computer.
